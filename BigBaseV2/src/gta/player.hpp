...
public:
	...
	DWORD packet_receiver_id; // 0x30
	std::int8_t active_id; //0x0034
	std::int8_t player_id; //0x0035
	char pad_0x0036[0xA]; //0x0036
	uint64_t unk_key; // 0x40
	char pad_0x0048[0x58]; //0x0048
	BYTE local_player_check;//0x00A0
	char pad_0x00A1[0xF]; //0x00A1
	CPlayerInfo* player_info; //0x00B0
	char pad_0x00B0[0x14]; //0x00B8
	std::uint32_t bubble_id; //0x00CC
	Player player; //0x00D0
